      ...
      <section className="max-w-6xl mx-auto px-6 pt-24 pb-20 md:pt-32 md:pb-28">
        ...
        <div className="mt-16 md:mt-20 rounded-xl border border-border bg-card overflow-hidden shadow-lg">
          ...
          <div className="p-6 md:p-8 font-mono text-sm text-muted-foreground space-y-2">
            <p><span className="text-success">✓</span> api.production <span className="text-muted-foreground/60">— 99.98% uptime — 142ms avg</span></p>
            <p><span className="text-success">✓</span> auth.production <span className="text-muted-foreground/60">— 99.99% uptime — 89ms avg</span></p>
            <p><span className="text-warning">⚠</span> cdn.staging <span className="text-muted-foreground/60">— 98.2% uptime — 340ms avg — degraded</span></p>
            <p><span className="text-success">✓</span> google-workspace <span className="text-muted-foreground/60">— synced 2m ago — 48/50 licenses</span></p>
            <p><span className="text-success">✓</span> slack-workspace <span className="text-muted-foreground/60">— synced 5m ago — all channels healthy</span></p>
